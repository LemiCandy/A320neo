...
var APVertSpeedSet = func
 ...
 if (altitude and altitudeSetting and vertSpeedSetting and math.abs(altitude - altitudeSetting) > 100)
  {
  if (altitude > altitudeSetting)
   {
   setprop("autopilot/settings/vertical-speed-fpm", -2000);
   }
	if (altitude > altitudeSetting and vertSpeedSetting >= -600)
   	{
   setprop("autopilot/settings/vertical-speed-fpm", -600);
   	}
	if (altitude > altitudeSetting and vertSpeedSetting == -700)
   	{
   setprop("autopilot/settings/vertical-speed-fpm", -700);
   	}
	if (altitude > altitudeSetting and vertSpeedSetting == -800)
   	{
   setprop("autopilot/settings/vertical-speed-fpm", -800);
   	}
if (altitude > altitudeSetting and vertSpeedSetting == -900)
   	{
   setprop("autopilot/settings/vertical-speed-fpm", -900);
   	}
if (altitude > altitudeSetting and vertSpeedSetting == -1000)
   	{
